...
class NewCustomercreate implements ObserverInterface
{
        protected $_curl;
        protected $_request;
        protected $_helper;
    ...
    {
        $customerLoginConform = $this->scopeConfig->getValue("customer/create_account/confirm");
        if ($customerLoginConform==0) {
